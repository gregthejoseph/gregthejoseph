# streamlit run "/Users/gregoryjoseph/Downloads/dsp_at3_group32/app/streamlit_app.py"
...
st.title("CSV Explorer WebApp by Group 32")
...
if uploaded_file is not None:
    try:
        ...
        st.error("The uploaded CSV file is either empty or invalid. Please reupload a valid CSV file.")
else:
